...
def main():
    ...
    st.set_page_config(page_title="아크노바", page_icon❤️", layout="centered")  # 레이아웃을 설정하여 폰트 경고를 방지
    st.image('main.png')  # 상단에 이미지를 표시
    st.title("_:red[아크노바 룰북 안내용_윌슨]_ 🏫")  # 제목 표시 (에너지 학습 도우미)
    st.header("😵‍💫윌슨에게 룰을 물어보세요. 가끔 모를 수도 있어요!✌️", divider='rainbow')  # 주의사항 표시
